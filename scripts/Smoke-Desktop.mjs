...
try {
  ...
  await exited
  log('Desktop smoke test passed: permanent task/history deletion, legacy cleanup, bundled privacy notice, encrypted migration, restricted storage, corruption rejection, overlay persistence, startup settings and lock/unlock. Used a debug-only isolated profile; original startup entries are restored.')
} finally {
